    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="${homeUrl}">
                <img alt="Brand" width="20" height="20" src="images/logo.jpg">
            </a>
            <a class="navbar-brand" href="${homeUrl}">AlephShop</a>
        </div>
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
                <c:url var="phonesUrl" value="/phones"/>
                <li class="${param.page eq 'items' ? 'active' : ''}"><a href="${phonesUrl}">Items</a></li>
                ...
                <li class="${param.page eq 'user_orders' ? 'active' : ''}"><a href="${userOrdersUrl}">User orders</a>
                </li>
            </ul>
        </div>
        <!--/.nav-collapse -->
